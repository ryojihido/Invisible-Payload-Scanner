...
- Adds **release-authenticity verification**: a one-line `Get-FileHash` SHA-256 check for the downloaded zip documented in the README, and the startup banner separately prints the running script's own SHA-256.
